---
layout: default
title: Tiation Rigger Mobile App - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Mobile App</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-mobile-app" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-rigger-mobile-app .

# Run container
docker run -p 8080:8080 tiation-rigger-mobile-app
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-mobile-app)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-mobile-app/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-mobile-app/discussions)
